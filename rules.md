...
<blockquote>Эти правила принадлежат исключительно проекту LightGame 1.6 Копируя эти правила без разрешения вы автоматически опускаетесь ниже плинтуса. Я не против поделиться этими правилами с вами, стоит только попросить.</blockquote>
